...
const getServices = (services) => {
  return services.map((service) => {
    return { id: service.id, value: service.info.name };
  });
};
...
export default class BookingsList extends React.Component {
  ...
  _renderBookingsListToolbar = () => {
    const { filters, services } = this.props;
  ...
  render() {
    ...
    // console.logx(Object.values(this.props.services));
    console.logx(
      Object.values(this.props.services).map((service) => {
        return { value: service.info.name, id: service.id };
      })
    );
    return (
